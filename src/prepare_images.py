...
5. Write:
   ...
   one level up from `stim_generation/`.
...
From the repo root (recommended):
    ...
    python -m stim_generation.prepareimage4experiment

Or from inside `stim_generation/`:

    python prepareimage4experiment.py
"""
...
def get_paths(
  ...
  # Final processed stimuli go into a subfolder of output
...
def _catch_write_js(out_path: Path, triplets: list[dict[str, Any]]) -> None:
  header = (
    "// Auto-generated by LLM_prepareimage4experiment.py\n"
